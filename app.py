...
def success():
    if request.method == 'POST':
        ...
        def VGG16_Places365(model_file=None):
            ...
            return model
        #Function is used to predict the images uploaded by the user: Parameter 1:List of image files,Parameter 2:Top 5 Labels ,Model to use
        ...
        #predicting images and stroring it in the form of list and then sending it to the HTML page
